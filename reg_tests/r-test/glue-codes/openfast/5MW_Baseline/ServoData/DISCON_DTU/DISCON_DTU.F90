...
REAL(4), PARAMETER           :: CornerFreq    =       1                         ! Corner frequency (-3dB point) in the recursive, single-pole, low-pass filter, rad/s. -- chosen to be 1/4 the blade edgewise natural frequency ( 1/4 of approx. 1Hz = 0.25Hz = 1.570796rad/s)
...
REAL(4), PARAMETER           :: PC_KI         =       0.04333                   ! Integral gain for pitch controller at rated pitch (zero), (-).
REAL(4), PARAMETER           :: PC_KK         =       164.13                   ! Pitch angle where the the derivative of the aerodynamic power w.r.t. pitch has increased by a factor of two relative to the derivative at rated pitch (zero), rad.
REAL(4), PARAMETER           :: PC_KP         =       0.033445                  ! Proportional gain for pitch controller at rated pitch (zero), sec.
REAL(4), PARAMETER           :: PC_MaxPit     =       1.5708                    ! Maximum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_MaxRat     =       0.17453                  ! Maximum pitch  rate (in absolute value) in pitch  controller, rad/s.
REAL(4), PARAMETER           :: PC_MinPit     =       0.0                       ! Minimum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_RefSpd     =     50.266                      ! Desired (reference) HSS speed for pitch controller, rad/s.
...
REAL(4), PARAMETER           :: VS_CtInSp     =      26.18                      ! Transitional generator speed (HSS side) between regions 1 and 1 1/2, rad/s.
...
REAL(4), PARAMETER           :: VS_MaxTq      =   250000.0                      ! Maximum generator torque in Region 3 (HSS side), N-m. -- chosen to be 10% above VS_RtTq = 43.09355kNm
REAL(4), PARAMETER           :: VS_Rgn2K      =       104.1                     ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
REAL(4), PARAMETER           :: VS_Rgn2Sp     =      31.4159                    ! Transitional generator speed (HSS side) between regions 1 1/2 and 2, rad/s.
...
REAL(4), PARAMETER           :: VS_RtGnSp     =   50.265                      ! Rated generator speed (HSS side), rad/s. -- chosen to be 99% of PC_RefSpd
REAL(4), PARAMETER           :: VS_RtPwr      =   10000000                      ! Rated generator generator power in Region 3, Watts. -- chosen to be 5MW divided by the electrical generator efficiency of 94.4%
...
REAL(4), PARAMETER           :: VS_SlPc       =      0.0                       ! Rated generator slip percentage in Region 2 1/2, %.
